        ...
        <Container>
            ...
            <Row className='justify-content-start mx-0 mb-3'>
                <p>
                    ...
                    key positions of the Sun and Moon are presented on the tide graph as a way to
                    better understand the tide patterns. While there are other drivers of coastal
                    flooding such as weather, local topography and sea level rise, in the lunar
                    month, the highest tides usually occur around New Moon and Full Moon.
                </p>
                <p>
