...
class TestAstro(TestCase):
    def test_parse_15m_predictions(self):
        ...
        zone = tz.eastern
        raw = util.read_file(f"{test_data_path}/data/astro_15m.json")
    ...
    def test_parse_hilo_predictions(self):
        ...
        raw = util.read_file(f"{test_data_path}/data/astro_hilo_3days.json")
        contents = astro.extract_json(raw)
    ...
    def test_api_error(self):
        ...
        raw = util.read_file(f"{test_data_path}/data/astro_error.json")
