...
class TestCdmo(TestCase):
    def test_parse_wind_xml(self):
        ...
        self.assertEqual(len(winds), 96)
        self.assertNotIn(datetime(2025, 12, 27, 23, 45, tzinfo=tzone), winds)
        self.assertNotIn(datetime(2025, 12, 28, 0, 15, tzinfo=tzone), winds)
        self.assertNotIn(datetime(2025, 12, 29, 0, 15, tzinfo=tzone), winds)
